...
function remove_contribute_notification(){
	try{
		document.querySelector('body > div.modal.ng-scope.ng-isolate-scope.in').remove();
	}catch{}
	try{
		document.querySelector('body > div.modal-backdrop.ng-scope.in').remove();
	}catch{}
	setTimeout(remove_contribute_notification, 1000);
}
...
remove_contribute_notification(); // 기부 알람 없애기